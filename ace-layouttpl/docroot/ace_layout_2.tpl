<div class="ace_layout_2" id="main-content" role="main">
#if ($browserSniffer.isIe($request) && $browserSniffer.getMajorVersion($request) < 8)
	<table class="portlet-layout">
		<tr>
			<td class="aui-w70 portlet-column portlet-column-first" id="column-left">
			...
			<td class="aui-w30 portlet-column portlet-column-last" id="column-4">
