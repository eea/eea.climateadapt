...
<aui:button-row>
	...
	<aui:button value="Add item" onClick="<%=addAceItemURL.toString()%>"/>
    ...
    <aui:button type="submit" value="Delete selected items" onClick="this.form.elements['submitAction'].value='delete';return true;"/>
