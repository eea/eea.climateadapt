...
<% if ((renderRequest.isUserInRole("Portal Content Reviewer") || renderRequest.isUserInRole("administrator"))  )  { // || renderRequest.isUserInRole("Power User")) { %>
	<input type="checkbox" name="chk_controlstatus" id="chk_controlstatus" value="1" <% if ((renderRequest.isUserInRole("Portal Content Reviewer") || renderRequest.isUserInRole("administrator")) && (aceitem != null) && (aceitem.getControlstatus() == 1) ) { out.print( "checked" ) ; } %> />
	<b>Approved</b>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
<% } %>
