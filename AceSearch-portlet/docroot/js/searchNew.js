jQuery(document).ready(function() {
	...
	$j('.case-studies-database-search-filters-section-header').click(function(e){
		e.preventDefault();
		$j(this).next('.case-studies-database-search-filters-options').slideToggle(function(){
			if ($j(this).css('display') == 'none') {
				$j(this).prev('.case-studies-database-search-filters-section-header').find('.case-studies-database-search-filters-section-header-icon').text('+');
			} else {
				$j(this).prev('.case-studies-database-search-filters-section-header').find('.case-studies-database-search-filters-section-header-icon').text('-');
			}
		});
	...
	$j('.case-studies-database-search-filters-section').each(function(){
		...
		$j(this).find('input[type="radio"]').change(function(){
			$j(this).closest('.case-studies-database-search-filters-section').find('.case-studies-database-search-filters-sub-options').slideToggle(function(){
				$j(this).find('input[type="checkbox"]').attr('checked', false);;
			});
		});
	});
