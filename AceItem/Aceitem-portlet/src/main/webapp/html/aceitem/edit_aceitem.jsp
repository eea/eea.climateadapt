...
<% } %>
	...
	<div style="float: left; margin-right: 35px;">
        ...
        <input id="<portlet:namespace />descriptionField" type="hidden" name="description" value="<%= aceitem==null ? "" : (aceitem.getDescription()==null ? "" : HtmlUtil.escapeAttribute(aceitem.getDescription())) %>"/>
        <br/>
