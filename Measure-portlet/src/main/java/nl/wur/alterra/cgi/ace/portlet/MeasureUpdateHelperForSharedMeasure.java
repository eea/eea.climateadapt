...
public abstract class MeasureUpdateHelperForSharedMeasure extends MVCPortlet {
    ...
    protected void measureFromRequest(PortletRequest request, Measure measure, UploadPortletRequest req, List errors) throws Exception {
        ...
        if (Validator.isNotNull(sourceFileName) && (sourceFileName.endsWith(".png")
            ...
            //comment out the following if case - https://taskman.eionet.europa.eu/issues/71395
            /*
            if (Validator.isNotNull(primePhotoId)) {
                ...
                System.out.println("image source filename: "+sourceFileName);
                if (! image.getTitle().equalsIgnoreCase(sourceFileName)) {
                    try {
                        ...
                        System.out.println("photo primary key: "+primaryKey);
...
//                }
            ...
            if (Validator.isNotNull(uploadRequest.getParameter("supphotos"))) {
                ...
                for (int counter = 1; counter <= photoCounter; counter++) {
                    ...
                    if (Arrays.asList(supPhotoIdsStored).contains(sup_photo_id)) {
                        ...
                        // upload the image
                        FileEntry image = insertImage(uploadRequest, counter, imageFolder, sup_photo_name, sup_photo_description, themeDisplay, serviceContext, errors, request);
        ...
        for (int counter = 1; counter <= docCounter; counter++) {
            ...
            if (isDocsValid && !Arrays.asList(supDocIdsStored).contains(sup_doc_id) && !(sup_doc_fileName.endsWith(".pdf")
...
//        }
    ...
    private FileEntry insertImage(UploadPortletRequest uploadRequest, int counter, Folder imageFolder, String sup_photo_name,
            String sup_photo_description, ThemeDisplay themeDisplay, ServiceContext serviceContext, List errors, PortletRequest request) throws Exception {
    ...
    private DLFileEntry updateFileEntry(Long fileEntryId, String fileTitle, String fileDesc) throws Exception {
        ...
        if ( !dlFileEntry.getTitle().equals(fileTitle) || !dlFileEntry.getDescription().equals(fileDesc) ) {
	        // update the image
	        try {
	        	dlFileEntry.setTitle(fileTitle);
	        	dlFileEntry.setDescription(fileDesc);
...
*/
    ...
    private void addPermissions(ThemeDisplay themeDisplay, String primaryKey, String resource) throws Exception {
        //System.out.println("inside addPermissions");
        ...
        try {
            ...
            //System.out.println("after creating resourceAction");
            ...
            //System.out.println("before setting primary key: " + primaryKey + " to resource permission");
