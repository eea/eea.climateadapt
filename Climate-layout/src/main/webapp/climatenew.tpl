<div class="climatenew" id="main-content" role="main">
	<div class="portlet-layout row-fluid">
		<div class="portlet-column portlet-column-only span8" id="column-1">
			$processor.processColumn("column-1", "portlet-column-content portlet-column-content-only")
		</div>
		<div class="portlet-column portlet-column-only span4" id="column-2">
	...
	<div class="portlet-layout row-fluid">
		...
		<div class="portlet-column portlet-column-last span6" id="column-4">
	...
	<div class="portlet-layout row-fluid">
		...
		<div class="portlet-column portlet-column-last span3" id="column-6">
			$processor.processColumn("column-6", "portlet-column-content portlet-column-content-last")
		</div>

		<div class="portlet-column portlet-column-first span3" id="column-7">
			$processor.processColumn("column-7", "portlet-column-content portlet-column-content-first")
		</div>

		<div class="portlet-column portlet-column-last span3" id="column-8">
			$processor.processColumn("column-8", "portlet-column-content portlet-column-content-last")
		</div>
	</div>

	<div class="portlet-layout row-fluid">
		<div class="portlet-column portlet-column-only span12" id="column-9">
