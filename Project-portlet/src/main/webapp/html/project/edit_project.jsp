...
<% } %>
	  ...
	  <div style="float: left; margin-right: 35px;">
		...
		<input id="<portlet:namespace />abstractsField" type="hidden" name="abstracts" value="<%= project==null ? "" : (project.getAbstracts()==null ? "" : HtmlUtil.escapeAttribute(project.getAbstracts())) %>"/><br /><br />
