...
String cityProfileVisible = "";
if (user.getScreenName().equals("cityprofilecontact"))
	cityProfileVisible = "hide";
%>
	...
	<div class="journal-article-body-content">
		...
		<div class="journal-article-header-edit" id="<portlet:namespace />articleHeaderEdit">
			...
			<c:if test="<%= Validator.isNull(toLanguageId) %>">
				<div class="article-structure-template-toolbar journal-metadata <%=cityProfileVisible%>">
			...
			<div class="article-translation-toolbar journal-metadata <%=cityProfileVisible%>">
...
In the meantime, feel free to fill in the following form, including contact details as well as first information on your municipality's adaptation action status. Only the underscored fields need to be filled in at the registration stage.
